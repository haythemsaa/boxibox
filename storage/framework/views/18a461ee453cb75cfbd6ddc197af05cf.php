...
<head>
    ...
    <title>Connexion - <?php echo e(config('app.name', 'Boxibox')); ?></title>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if(Route::has('register')): ?>
                    <div class="text-center mt-4">
                        <p class="mb-0">
                            ...
                            <a href="<?php echo e(route('register')); ?>" class="forgot-password">
                                S'inscrire
                            </a>
                        </p>
                    </div>
                ...
                <div class="text-center mt-4">
                    <small class="text-muted">
                        © <?php echo e(date('Y')); ?> Boxibox. Solution de gestion de self-stockage.
                    </small>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp2025\htdocs\boxibox\resources\views/auth/login.blade.php ENDPATH**/ ?>